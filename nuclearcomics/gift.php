	...
	<div class="well">
		<div class="row">
			...
			<div class="span3" style="margin-top: 10px;">						
				<a href="gift_purchase.php?s_id=<?php echo $subscription_info['subscription_type_id']; ?>&term=3" class="btn btn-large btn-block btn-success">Purchase</a>
			</div>
		</div>
	</div>
	<div class="well">
		<div class="row">
			...
			<div class="span3" style="margin-top: 10px;">						
				<a href="gift_purchase.php?s_id=<?php echo $subscription_info['subscription_type_id']; ?>&term=6" class="btn btn-large btn-block btn-success">Purchase</a>
			</div>
		</div>
	</div>
	<div class="well">
		<div class="row">
			...
			<div class="span3" style="margin-top: 10px;">						
				<a href="gift_purchase.php?s_id=<?php echo $subscription_info['subscription_type_id']; ?>&term=12" class="btn btn-large btn-block btn-success">Purchase</a>
			</div>
		</div>
	</div>
</div>
