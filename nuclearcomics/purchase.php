	...
	if (isset($_GET['preapproval_id'])) {
		...
		if (uniquePreapproval($_GET['preapproval_id']) == 0) {
			...
			$args = array(
				'key' => 'HaVrKwsIhLsI8vsnlhn0QA',
				'message' => array(
					"html" => "<p>\r\n\tThanks for signing up!</p>\r\n<p>\r\n\tTo view your account <a href=\"http://citypackr.com/account.php\">click here</a> and sign in with this e-mail and your temporary password: password</p>",
					"text" => null,
					"from_email" => "evo@citypackr.com",
					"from_name" => "CakeBaby Bakery",
					"subject" => "Confirmation - My Cupcake Runneth Over",
					"to" => array(array("email" => $e)),
					"track_opens" => true,
					"track_clicks" => true,
					"auto_text" => true
