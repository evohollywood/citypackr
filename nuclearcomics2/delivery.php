...
<div class="container">
	<div class="well" style="height: 150px; margin-top: 60px; background-color: white;">
		<div class="span2">
			<ul class="thumbnails">
				<li class="span2">
					<div class="thumbnail">
	...
	<div class="well" style="background-color: white;">
		...
		<div class="row">
			<div class="span3">
				<a border="0" onClick="timeout_trigger()">
					<div style="padding-top: 15px; text-align: center; font-size: 150%; font-family: cp_font; color: white; border: 0; width: 100%; height: 47px; background: url(/images/button_cancel.png) no-repeat center top;">
						CANCEL
					</div>
				</a>
			</div>
			<div class="span3 offset5">
				<input type="submit" value="SUBMIT" style="font-size: 150%; font-family: cp_font; color: white; border: 0; width: 100%; height: 47px; background: url(/images/button_next.png) no-repeat center top;" />
				</form>
			</div>
		</div>
	</div>
